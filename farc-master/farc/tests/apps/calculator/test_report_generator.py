...
from farc.apps.calculator import make_app
from farc.apps.calculator.report_generator import ReportGenerator, readable_minutes
import farc.apps.calculator.report_generator as rep_gen


def test_generate_report(baseline_form):
    # This is a simple test that confirms that given a model, we can actually
    # generate a report for it. Because this is what happens in the farc
