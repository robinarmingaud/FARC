...
from farc.apps.calculator.model_generator import _hours2timestring
from farc.apps.calculator.model_generator import minutes_since_midnight
from farc import models
from farc.monte_carlo.data import expiration_distributions
...
def test_ventilation_window_biov(baseline_form: model_generator.FormData):
    baseline_form.ventilation_type = 'natural_ventilation'
    baseline_form.windows_duration = 10
    baseline_form.windows_frequency = 120
    baseline_form.window_opening_regime = 'windows_open_periodically'
    ...
    baseline_form.window_height = 1.6
    baseline_form.opening_distance = 0.6
    baseline_form.biov_option = True
    ...
    ventilation = models.MultipleVentilation((window, biov, ach))
