...
Room1 = multi_room_model.Room('Test',100,Ventilation1,1, 0.4, 20.)
Event1 = multi_room_model.Event(0, 12, Room1, 0.0, 'Type_I', 'Office_worker')
Event2 = multi_room_model.Event(0, 12, Room1, 0.0, 'Type_I', 'Concert_musician_rock')
...
Person1 = multi_room_model.Person('Office worker', 1, schedule = Schedule1)
Person2 = multi_room_model.Person('Office worker', 2, schedule = Schedule1)
