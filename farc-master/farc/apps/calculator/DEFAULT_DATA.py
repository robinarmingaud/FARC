...
def set_locale (locale):
    ...
    _DEFAULTS = {
            ...
            'ventilation_type': 'mechanical_ventilation',
            'virus_type': "SARS_CoV_2_OMICRON",
            'viruses' : {"SARS_CoV_2" : "SARS-CoV-2 (nominal strain)", "SARS_CoV_2_ALPHA" : _("SARS-CoV-2 (Alpha VOC)"), "SARS_CoV_2_BETA" : _("SARS-CoV-2 (Beta VOC)"), "SARS_CoV_2_GAMMA": _("SARS-CoV-2 (Gamma VOC)"), "SARS_CoV_2_DELTA" : _("SARS-CoV-2 (Delta VOC)"), "SARS_CoV_2_OMICRON" :_("SARS-CoV-2 (Omicron VOC)")},
            'volume_type': 'room_volume_explicit',
            'window_type': 'window_sliding',
            'window_height': 1.,
            'window_width': 1.,
