...
ACTIVITY_TYPES = [{'Group':_('Business'),'Id':'Office_worker', 'Name' : _('Office worker'), 'Activity' : _('Seated'), 'Expiration' : {_('Speaking'): 2, _('Breathing'): 8}},
                ...
                {'Group':_('Hospital'),'Id':'Hospital_patient', 'Name' : _('Hospital patient'), 'Activity' : _('Seated'), 'Expiration' : {_('Speaking'): 0.5, _('Breathing'): 9.5}},
                {'Group':_('Hospital'),'Id':'Nurse_working', 'Name' : _('Nurse working'), 'Activity' : _('Light activity'), 'Expiration' : {_('Speaking'): 2, _('Breathing'): 8}},
                {'Group':_('Hospital'),'Id':'Physician_working', 'Name' : _('Physician working'), 'Activity' : _('Standing'), 'Expiration' : {_('Speaking'): 5, _('Breathing'): 5}},
                {'Group':_('Education'),'Id':'Student_sitting', 'Name' : _('Student sitting'), 'Activity' : _('Seated'), 'Expiration' : {_('Speaking'):0.5 , _('Breathing'): 9.5}},
                {'Group':_('Education'),'Id':'Professor_teaching', 'Name' : _('Professor teaching'), 'Activity' : _('Standing'), 'Expiration' : {_('Speaking'): 6, _('Breathing'): 2, _('Shouting'):2}},
                {'Group':_('Education'),'Id':'Professor_conferencing', 'Name' : _('Professor conferencing'), 'Activity' : _('Light activity'), 'Expiration' : {_('Speaking'):2,_('Breathing'):2, _('Shouting'):6}},
                {'Group':_('Events'),'Id':'Concert_musician_soft_music', 'Name' : _('Concert musician (soft music)'), 'Activity' : _('Standing'), 'Expiration' : {_('Speaking'):0.5,_('Breathing'):9.5}},
                {'Group':_('Events'),'Id':'Concert_musician_rock', 'Name' : _('Concert musician (rock)'), 'Activity' : _('Moderate activity'), 'Expiration' : {_('Speaking'):1,_('Breathing'):8, _('Shouting'):1}},
                {'Group':_('Events'),'Id':'Concert_singer_rock', 'Name' : _('Concert singer (rock)'), 'Activity' : _('Moderate activity'), 'Expiration' : {_('Speaking'):1,_('Breathing'):2, _('Shouting'):7}},
                {'Group':_('Events'),'Id':'Concert_spectator_standing', 'Name' : _('Concert spectator (standing)'), 'Activity' : _('Light activity'), 'Expiration' : {_('Speaking'):1,_('Breathing'):8, _('Shouting'):1}},
                {'Group':_('Events'),'Id':'Concert_spectator_sitting', 'Name' : _('Concert spectator (sitting)'), 'Activity' : _('Seated'), 'Expiration' : {_('Speaking'):0.5,_('Breathing'):9, _('Shouting'):0.5}},
                {'Group':_('Events'),'Id':'Museum_visitor', 'Name' : _('Museum visitor'), 'Activity' : _('Standing'), 'Expiration' : {_('Speaking'):1,_('Breathing'):9}},
                {'Group':_('Events'),'Id':'Theater_spectator', 'Name' : _('Theater spectator'), 'Activity' : _('Seated'), 'Expiration' : {_('Speaking'):0.5,_('Breathing'):9, _('Shouting'):0.5}},
                {'Group':_('Events'),'Id':'Theater_actor', 'Name' : _('Theater actor'), 'Activity' : _('Moderate activity'), 'Expiration' : {_('Breathing'):7, _('Shouting'):3}},
                {'Group':_('Events'),'Id':'Conferencer', 'Name' : _('Conferencer'), 'Activity' : _('Light activity'), 'Expiration' : {_('Speaking'):2, _('Breathing'):2, _('Shouting'):6}},
                {'Group':_('Events'),'Id':'Conference_attendee', 'Name' : _('Conference attendee'), 'Activity' : _('Seated'), 'Expiration' : {_('Speaking'):0.5, _('Breathing'):9.5}},
                {'Group':_('Restaurant and Bar'),'Id':'Guest_standing', 'Name' : _('Guest standing'), 'Activity' : _('Standing'), 'Expiration' : {_('Speaking'):2, _('Breathing'):6, _('Shouting'):2}},
                {'Group':_('Restaurant and Bar'),'Id':'Guest_sitting', 'Name' : _('Guest sitting'), 'Activity' : _('Seated'), 'Expiration' : {_('Speaking'):4, _('Breathing'):6}},
                {'Group':_('Restaurant and Bar'),'Id':'Server', 'Name' : _('Server'), 'Activity' : _('Light activity'), 'Expiration' : {_('Speaking'):2, _('Breathing'):8}},
                {'Group':_('Restaurant and Bar'),'Id':'Barrista', 'Name' : _('Barrista'), 'Activity' : _('Standing'), 'Expiration' : {_('Speaking'):2, _('Breathing'):6, _('Shouting'):2}}, 
                {'Group':_('Restaurant and Bar'),'Id':'Nightclub_dancing', 'Name' : _('Nightclub dancing'), 'Activity' : _('Moderate activity'), 'Expiration' : {_('Breathing'):9, _('Shouting'):1}},
                {'Group':_('Restaurant and Bar'),'Id':'Nightclub_sitting', 'Name' : _('Nightclub sitting'), 'Activity' : _('Seated'), 'Expiration' : {_('Breathing'):8, _('Shouting'):2}},
                {'Group':_('Store and Retail'),'Id':'Customer_standing', 'Name' : _('Customer standing'), 'Activity' : _('Standing'), 'Expiration' : {_('Speaking'):1,_('Breathing'):9}},
