var js_default = JSON.parse('{"exposed_activity_type": "Office_worker", "exposed_mask_wear_ratio": 0.7, "infected_activity_type": "Office_worker", "infected_mask_wear_ratio": 0.7, "air_changes": 1.0, "air_supply": 100, "calculator_version": "1.0.0", "ceiling_height": 2.5, "exposed_coffee_break_option": "coffee_break_0", "exposed_coffee_duration": 5, "exposed_finish": "17:30", "exposed_lunch_finish": "13:30", "exposed_lunch_option": true, "exposed_lunch_start": "12:30", "exposed_start": "08:30", "event_month": "January", "floor_area": 40, "biov_amount": 1000, "biov_option": 0, "infected_coffee_break_option": "coffee_break_0", "infected_coffee_duration": 5, "infected_dont_have_breaks_with_exposed": false, "infected_finish": "17:30", "infected_lunch_finish": "13:30", "infected_lunch_option": true, "infected_lunch_start": "12:30", "infected_people": 1, "infected_start": "08:30", "location_latitude": 47.21725, "location_longitude": -1.55336, "location_name": "Nantes, FRA", "mask_type": "Type_I", "mask_wearing_option": "mask_off", "mechanical_ventilation_type": "mech_type_air_supply", "opening_distance": 0.5, "room_heating_option": 1, "room_number": "Boardroom", "room_volume": 100, "simulation_name": "Workshop without masks", "total_people": 10, "ventilation_type": "mechanical_ventilation", "virus_type": "SARS_CoV_2_OMICRON", "viruses": {"SARS_CoV_2": "SARS-CoV-2 (nominal strain)", "SARS_CoV_2_ALPHA": "SARS-CoV-2 (Alpha VOC)", "SARS_CoV_2_BETA": "SARS-CoV-2 (Beta VOC)", "SARS_CoV_2_GAMMA": "SARS-CoV-2 (Gamma VOC)", "SARS_CoV_2_DELTA": "SARS-CoV-2 (Delta VOC)", "SARS_CoV_2_OMICRON": "SARS-CoV-2 (Omicron VOC)"}, "volume_type": "room_volume_explicit", "window_type": "window_sliding", "window_height": 1.0, "window_width": 1.0, "windows_duration": 15, "windows_frequency": 60, "windows_number": 1, "window_opening_regime": "windows_open_permanently"}');
...
$(document).ready(function () {
  ...
  $(':radio[value='+heating_system+']').attr('checked', 'checked');
  var ventilation_type = js_default['ventilation_type']
  $(':radio[value='+ventilation_type+']').attr('checked', 'checked');
  var mechanical_ventilation_type = js_default['mechanical_ventilation_type']
  $(':radio[value='+mechanical_ventilation_type+']').attr('checked', 'checked');
  var window_type = js_default['window_type']
  $(':radio[value='+window_type+']').attr('checked', 'checked');
  var window_opening_regime = js_default['window_opening_regime']
  $(':radio[value='+window_opening_regime+']').attr('checked', 'checked');
  var biov_option = js_default['biov_option']
  $(':radio[value='+biov_option+']').attr('checked', 'checked');
  var mask_wearing_option = js_default['mask_wearing_option']
  $(':radio[value='+mask_wearing_option+']').attr('checked', 'checked');
  var mask_type = js_default['mask_type']
  $(':radio[value='+mask_type+']').attr('checked', 'checked');
